	...
	<div id="app">
		...
		<form class="form" action="searcherByTimePerioudAndComany.php" method="POST" v-show="!searchByFromToDate">
			<div class="form-group">
				...
				<input required name="start date" type="text" class="form-control" id="start date" placeholder="start date">
			</div>
			<div class="form-group">
				<label for="end date">End Date</label>
				<input required name="end date" type="text" class="form-control" id="end date" placeholder="end date">
			</div>
